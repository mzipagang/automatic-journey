...
class HttpClientService:
    ...
    http_put: Callable
    http_patch: Callable
    __httpx_client: HttpxClient = None
    __base_url: str = None
...
class InternalApiHttpClientService(HttpClientService):
    def __init__(self, config_service: ConfigService = Depends(ConfigService),
                 http_connection_service: HttpConnectionService = Depends(HttpConnectionService)):
        super().__init__(
            headers={
...
class ExternalApiHttpClientService(HttpClientService):
    def __init__(self, config_service: ConfigService = Depends(ConfigService),
                 http_connection_service: HttpConnectionService = Depends(HttpConnectionService)):
        super().__init__(
            headers={
...
class KoddiHttpClientService:
    ...
    def __get_koddi_token(self):
        ...
        response = self.__external_api_http_client.get(path="/ent-client-gateway/koddi/jwt")
...
def _safely_inject_auth_param(token: str, base_params: dict) -> dict:
...
class _VerbFunctors:
    @staticmethod
    def get(base_url: str, httpx_client: HttpxClient, base_params: dict):
        def __internal(path: str,
                       token: str,
                       params: dict = None,
            ...
            get_base_params = _safely_inject_auth_param(token, base_params)
    ...
    @staticmethod
    def post(base_url: str, httpx_client: HttpxClient, base_params: dict):
        def __internal(
                token: str,
                path: str,
                       params: dict = None,
            ...
            post_base_params = _safely_inject_auth_param(token, base_params)
    ...
    @staticmethod
    def put(base_url: str, httpx_client: HttpxClient, base_params: dict):
        def __internal(path: str,
                       token: str,
                       json: dict = None,
                       response_body_type=None,
            ...
            put_base_params = _safely_inject_auth_param(token, base_params)
    ...
    @staticmethod
    def patch(base_url: str, httpx_client: HttpxClient, base_params: dict):
        def __internal(path: str,
                       token: str,
            ...
            patch_base_params = _safely_inject_auth_param(token, base_params)
